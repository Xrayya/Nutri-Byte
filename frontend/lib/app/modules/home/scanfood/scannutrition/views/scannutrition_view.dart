...
class ScannutritionView extends GetView<ScannutritionController> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Do you want to eat this Salmon Salad?',
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: Get.width * 0.35,
                      child: nutriByteButton(text: 'Eat', onPressed: () {}),
                    ),
                  ],
                )
              ],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        nutritionCols('Carbs', 'Protein', 'Fat', 'Calories'),
                        const SizedBox(
                          width: 16,
                        ),
                        nutritionCols(': ', ': ', ': ', ': '),
                        ...
                        nutritionCols('11.76', '11.76', '4', '141.22'),
                        const SizedBox(
                          width: 16,
                        ),
                ...
                Text(
                  'You will consume 107.93 g from 100 g of targeted Protein. You have reached your calories consumption limit.',
                  textAlign: TextAlign.center,
  ...
  IntrinsicWidth nutritionCols(
    ...
    TextStyle textStyle =
        Get.textTheme.bodyLarge!.copyWith(color: Color(0xFF294B19));
